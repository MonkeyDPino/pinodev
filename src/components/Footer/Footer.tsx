...
/**
 * Inline, theme-aware social glyphs — the exact path data already
 * verified in `Home.tsx`'s own `SocialIcon`, reused rather than
 * re-derived (PR5 flagged this exact gap: the source assets in
 * `src/assets/` bake in a fixed white fill, invisible in the light
 * theme, the same defect PR3 fixed only in `Home.tsx`).
 */
